...
class LeNet(nn.Module):
    ...
    def __init__(self, input_channels, linear_size=16 * 5 * 5):
        super().__init__()
...
def get_model_dict(input_channels, linear_size=16 * 5 * 5):
    """
    return a dict of models
    """
    return {
        "cptcnn1": ConstantParallelTropicalLeNet1(input_channels, linear_size),
        "cptcnn2": ConstantParallelTropicalLeNet2(input_channels, linear_size),
        "cctcnn1": ConstantCompoundTropicalLeNet1(input_channels, linear_size),
        "cctcnn2": ConstantCompoundTropicalLeNet2(input_channels, linear_size),
    }

def get_model_dict_old(input_channels, linear_size=16 * 5 * 5):
    """
    return a dict of models
    """
    return {
        "tcnn1": TropicalLeNet1(input_channels, linear_size),
        "tcnn2": TropicalLeNet2(input_channels, linear_size),
        "tcnn3": TropicalLeNet3(input_channels, linear_size),
        "ctcnn1": CompoundTropicalLeNet1(input_channels, linear_size),
        "ctcnn2": CompoundTropicalLeNet2(input_channels, linear_size),
        "ctcnn3": CompoundTropicalLeNet3(input_channels, linear_size),
        "ctcnn4": CompoundTropicalLeNet4(input_channels, linear_size),
        "ptcnn1": ParallelTropicalLeNet1(input_channels, linear_size),
        "ptcnn2": ParallelTropicalLeNet2(input_channels, linear_size),
        "ptcnn3": ParallelTropicalLeNet3(input_channels, linear_size),
        "ptcnn4": ParallelTropicalLeNet4(input_channels, linear_size),
        "lenet": LeNet(input_channels, linear_size),
        "lenet_relu": LeNetReLU(input_channels, linear_size),
    }
