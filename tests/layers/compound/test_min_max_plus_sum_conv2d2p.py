...
class TestMinMaxPlusSumConv2d2p(unittest.TestCase):
    def test_forward(self):
        ...
        dtype = torch.float32
        conv = ParallelMinMaxPlusSumConv2d2p(
            in_channels,
            out_channels,
            kernel_size,
            stride,
    ...
    def test_backward(self):
        ...
        # Assert the beta gradient shape is correct
        expected_beta_gradient_shape = (out_channels, in_channels)
        self.assertEqual(conv.beta.grad.shape, expected_beta_gradient_shape)
